# #-------- class start
class  how_is_hypnosis_different_from_psychological_counseling extends celarientemplate
  # 
  # section html
  # 
  # 
  ...
  storybar: =>
    T.div "#storybar.o-grid__cell.order-2.bg-lighten-2", =>
      T.h1 => T.raw "How is hypnosis different from psychological counseling?"
      T.hr()
      @bloviation()
  # 
  # section bloviation
  ...
  bloviation: =>
    T.div "#bloviation.contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      T.p => T.raw "There are differences between traditions of therapy and hypnosis.  Hypnosis is almost always very brief and takes only a few sessions.  It is for people who are more comfortable with their own emotions and grounded in reality."
...
#-------- class end
page = new how_is_hypnosis_different_from_psychological_counseling
rendered =  T.render page.html
# ------- db start
db = {} unless db
db[id="597b839bd3cfff7cc5f9270e"] =
  ...
  accepted: true
  index: false
  sourcePath: "celarien/contents/old-contents/2007-05-27-0054-counseling.md"
  headlines: []
  tags: []
  memberOf: []
  created: "2017-07-28T18:34:03.581Z"
  lastEdited: "2017-07-28T18:34:03.581Z"
  published: "2017-07-28T18:34:03.581Z"
  embargo: "2017-12-31T23:59:59.000Z"
  captureDate: "2017-07-28T18:34:03.581Z"
  TimeStamp: "1501266843581"
  author: ""
  debug: ""
  snippets: "{}"
  id: "597b839bd3cfff7cc5f9270e"
