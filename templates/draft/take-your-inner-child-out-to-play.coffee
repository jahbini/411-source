...
class  take_your_inner_child_out_to_play extends celarientemplate
  ...
  bloviation: =>
    T.div "#bloviation.contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      ...
      T.p =>
        T.hr()
        T.raw "Holly Cox is a Licensed Clinical Professional Counselor, a Certified Dream Coach®, and a Certified Dream Coach Group Leader®.  She is committed to helping women design and maintain “dream-come-true” lives. Sign up for Holly’s “"
      ...
      T.div ".zemanta-pixie", =>
        T.a ".zemanta-pixie-a", href: "http://reblog.zemanta.com/zemified/18d38701-9024-4c7e-bdda-2387bf4e0994/", title: "Zemified by Zemanta", =>
          T.img ".zemanta-pixie-img", src: "http://img.zemanta.com/reblog_e.png?x-id=18d38701-9024-4c7e-bdda-2387bf4e0994", alt: "Reblog this post [with Zemanta]"
  # 
  # section header
  # 
...
# ------- db start
db = {} unless db
db[id="597b839bd3cfff7cc5f92713"] =
  ...
  accepted: true
  index: false
  sourcePath: "celarien/contents/old-contents/2008-09-27-1143-take-your-inner-child-out-to-play.md"
  headlines: []
  tags: []
  memberOf: []
