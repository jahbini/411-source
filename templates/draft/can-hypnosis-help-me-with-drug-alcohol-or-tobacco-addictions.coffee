# #-------- class start
class  can_hypnosis_help_me_with_drug_alcohol_or_tobacco_addictions extends celarientemplate
  # 
  # section html
  # 
  # 
  ...
  storybar: =>
    T.div "#storybar.o-grid__cell.order-2.bg-lighten-2", =>
      T.h1 => T.raw "Can hypnosis help me with drug, alcohol, or tobacco addictions?"
      T.hr()
      @bloviation()
  # 
  # section bloviation
...
#-------- class end
page = new can_hypnosis_help_me_with_drug_alcohol_or_tobacco_addictions
