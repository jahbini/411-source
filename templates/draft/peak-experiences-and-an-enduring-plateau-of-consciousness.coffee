  ...
  bloviation: =>
    T.div "#bloviation.contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      ...
      T.p =>
        ...
        T.span ".pullquote", => T.raw "part of an interconnected whole"
      ...
      T.p =>
        ...
        T.span ".pullquote", => T.raw "it may come from reading a chapter of the Bible or the Book  of Tao"
      ...
      T.p =>
        ...
        T.span ".pullquote", => T.raw "Any peak experience that allows a great connection of spirit is valid: no one,  let alone yourself, should be allowed to take it from you."
      T.p =>
        T.raw "Over at"
...
"""
      ...
      T.div ".zemanta-pixie", =>
        T.a ".zemanta-pixie-a", href: "http://reblog.zemanta.com/zemified/d776f8e9-92cb-46c3-90a2-bd292fad5a0f/", title: "Zemified by Zemanta", =>
          T.img ".zemanta-pixie-img", src: "http://img.zemanta.com/reblog_e.png?x-id=d776f8e9-92cb-46c3-90a2-bd292fad5a0f", alt: "Reblog this post [with Zemanta]"
  # 
  # section header
  # 
