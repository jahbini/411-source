...
#mainline.bg-silver.u-shadow
  ...
  .c-card__body
    .m1.bg-darken-1
      ...
      .container.right
        a-scene(embedded='embedded', physics='debug: false; driver: local; gravity: -9.6; friction: 0.10; restitution: 0.300;')
          a-entity(physics='mass:0;', position='0 8 15', rotation='0 0 0')
            a-camera(physics='mass:0;', universal-controls='universal-controls', body-static='body-static', mouse-cursor='mouse-cursor', look-controls='enabled:true', wasd-controls='enabled:true')
              a-cursor
          a-sphere#outie.blue(lowroller='debug:true; inner:4;outer:1;pursuit: 2,0;', position='-2 6 -10', radius='1', material='color:#EFff5E; transparent:true; opacity:0.3;')
          a-sphere.red(dynamic-body, lowroller='inner:9;outer:1;', position='-2 1.25 -15', radius='1.25', material='color:#EF005E; transparent:true; opacity:0.3;')
          a-sphere.red(dynamic-body, lowroller='inner:25;outer:25;pursuit: 2.2,0; pid: 200,500,1;', position='-1 13 0', radius='0.75', material='color:#ff0000; transparent:true; opacity:0.7;')
          a-sphere.red(dynamic-body, lowroller='inner:25;outer:25;pursuit: 2.2,0; pid: 200,500,1;', position='-2 12 0', radius='0.75', material='color:#ff0000; transparent:true; opacity:0.7;')
          a-sphere.red(dynamic-body, lowroller='inner:25;outer:25;pursuit: 2.2,0; pid: 200,500,1;', position='-3 11 0', radius='0.75', material='color:#ff0000; transparent:true; opacity:0.7;')
          a-sphere.red(dynamic-body, lowroller='inner:25;outer:25;pursuit: 2.2,0; pid: 200,500,1;', position='-4 10 0', radius='0.75', material='color:#ff0000; transparent:true; opacity:0.7;')
          a-sphere.red(dynamic-body, lowroller='inner:25;outer:25;pursuit: 2.2,0; pid: 200,500,1;', position='-5 9 0', radius='0.75', material='color:#ff0000; transparent:true; opacity:0.7;')
          a-sphere.red(dynamic-body, lowroller='inner:25;outer:25;pursuit: 2.2,0; pid: 200,500,1;', position='-6 8 0', radius='0.75', material='color:#ff0000; transparent:true; opacity:0.7;')
          a-sphere.red(dynamic-body, lowroller='inner:25;outer:25;pursuit: 2.2,0; pid: 200,500,1;', position='-7 7 0', radius='0.75', material='color:#ff0000; transparent:true; opacity:0.7;')
          a-sphere.red(dynamic-body, lowroller='inner:25;outer:25;pursuit: 2.2,0; pid: 200,500,1;', position='-8 6 0', radius='0.75', material='color:#ff0000; transparent:true; opacity:0.7;')
          a-sphere.red(dynamic-body, lowroller='inner:25;outer:25;pursuit: 2.2,0; pid: 200,500,1;', position='-9 5 0', radius='0.75', material='color:#ff0000; transparent:true; opacity:0.7;')
          a-sphere.red(dynamic-body, lowroller='inner:25;outer:25;pursuit: 2.2,0; pid: 200,500,1;', position='-10 4 0', radius='0.75', material='color:#ff0000; transparent:true; opacity:0.7;')
          a-sphere.green(dynamic-body, lowroller='inner:5;outer:1;pursuit: 2.2,0; pid: 1000,300,0.0001;', position='-1 12 2', radius='0.5', material='color:#00ff00; transparent:true; opacity:0.7;')
          a-sphere.green(dynamic-body, lowroller='inner:5;outer:1;pursuit: 2.2,0; pid: 1000,300,0.0001;', position='-2 11 2', radius='0.5', material='color:#00ff00; transparent:true; opacity:0.7;')
          a-sphere.green(dynamic-body, lowroller='inner:5;outer:1;pursuit: 2.2,0; pid: 1000,300,0.0001;', position='-3 10 2', radius='0.5', material='color:#00ff00; transparent:true; opacity:0.7;')
          a-sphere.green(dynamic-body, lowroller='inner:5;outer:1;pursuit: 2.2,0; pid: 1000,300,0.0001;', position='-4 9 2', radius='0.5', material='color:#00ff00; transparent:true; opacity:0.7;')
          a-sphere.green(dynamic-body, lowroller='inner:5;outer:1;pursuit: 2.2,0; pid: 1000,300,0.0001;', position='-5 8 2', radius='0.5', material='color:#00ff00; transparent:true; opacity:0.7;')
          a-sphere.green(dynamic-body, lowroller='inner:5;outer:1;pursuit: 2.2,0; pid: 1000,300,0.0001;', position='-6 7 2', radius='0.5', material='color:#00ff00; transparent:true; opacity:0.7;')
          a-sphere.green(dynamic-body, lowroller='inner:5;outer:1;pursuit: 2.2,0; pid: 1000,300,0.0001;', position='-7 6 2', radius='0.5', material='color:#00ff00; transparent:true; opacity:0.7;')
          a-sphere.green(dynamic-body, lowroller='inner:5;outer:1;pursuit: 2.2,0; pid: 1000,300,0.0001;', position='-8 5 2', radius='0.5', material='color:#00ff00; transparent:true; opacity:0.7;')
          a-sphere.green(dynamic-body, lowroller='inner:5;outer:1;pursuit: 2.2,0; pid: 1000,300,0.0001;', position='-9 4 2', radius='0.5', material='color:#00ff00; transparent:true; opacity:0.7;')
          a-sphere.green(dynamic-body, lowroller='inner:5;outer:1;pursuit: 2.2,0; pid: 1000,300,0.0001;', position='-10 3 2', radius='0.5', material='color:#00ff00; transparent:true; opacity:0.7;')
          a-sphere.blue(dynamic-body, lowroller='inner:5;outer:1;pursuit: 2.2,0; pid: 200,400,0.1;', position='-1 9 -2', radius='0.75', material='color:#0000ff; transparent:true; opacity:0.7;')
          a-sphere.blue(dynamic-body, lowroller='inner:5;outer:1;pursuit: 2.2,0; pid: 200,400,0.1;', position='-2 8 -2', radius='0.75', material='color:#0000ff; transparent:true; opacity:0.7;')
          a-sphere.blue(dynamic-body, lowroller='inner:5;outer:1;pursuit: 2.2,0; pid: 200,400,0.1;', position='-3 7 -2', radius='0.75', material='color:#0000ff; transparent:true; opacity:0.7;')
          a-sphere.blue(dynamic-body, lowroller='inner:5;outer:1;pursuit: 2.2,0; pid: 200,400,0.1;', position='-4 6 -2', radius='0.75', material='color:#0000ff; transparent:true; opacity:0.7;')
          a-sphere.blue(dynamic-body, lowroller='inner:5;outer:1;pursuit: 2.2,0; pid: 200,400,0.1;', position='-5 5 -2', radius='0.75', material='color:#0000ff; transparent:true; opacity:0.7;')
          a-sphere.blue(dynamic-body, lowroller='inner:5;outer:1;pursuit: 2.2,0; pid: 200,400,0.1;', position='-6 4 -2', radius='0.75', material='color:#0000ff; transparent:true; opacity:0.7;')
          a-sphere.blue(dynamic-body, lowroller='inner:5;outer:1;pursuit: 2.2,0; pid: 200,400,0.1;', position='-7 3 -2', radius='0.75', material='color:#0000ff; transparent:true; opacity:0.7;')
          a-sphere.blue(dynamic-body, lowroller='inner:5;outer:1;pursuit: 2.2,0; pid: 200,400,0.1;', position='-8 2 -2', radius='0.75', material='color:#0000ff; transparent:true; opacity:0.7;')
          a-sphere.blue(dynamic-body, lowroller='inner:5;outer:1;pursuit: 2.2,0; pid: 200,400,0.1;', position='-9 1 -2', radius='0.75', material='color:#0000ff; transparent:true; opacity:0.7;')
          a-sphere.blue(dynamic-body, lowroller='inner:5;outer:1;pursuit: 2.2,0; pid: 200,400,0.1;', position='-10 0 -2', radius='0.75', material='color:#0000ff; transparent:true; opacity:0.7;')
          a-sphere(dynamic-body, position='0 .25 -2.2', radius='.25', material='color:#EF005E; transparent:true; opacity:0.3;')
          a-box(dynamic-body, position='0 4.5 -5', rotation='0 45 0', width='2', height='2', depth='2', color='#4CC3D9')
          a-box(static-body, position='-10 3.5 -7', rotation='0 45 0', width='0.1', height='1.0', depth='0.1', color='#22CC22')
          a-box(static-body, position='2 3.5 -5', rotation='0 45 0', width='0.1', height='1.0', depth='0.1', color='#4CC3D9')
          a-box(static-body, position='-2 3.5 -5', rotation='0 45 0', width='0.1', height='1.0', depth='0.1', color='#4CC3D9')
          a-box(static-body, position='-4 3.5 -3', rotation='0 45 0', width='0.1', height='1.0', depth='0.1', color='#4CC3D9')
          a-box(static-body, position='8 3.5 -10', rotation='0 45 0', width='0.1', height='1.0', depth='0.1', color='#4CC3D9')
          a-cylinder(static-body, position='-1 0.75 -3', radius='0.5', height='1.5', color='#FFC65D')
          a-sky(color='#cceecc')
          a-box(position='-2 0 0', width='0.1', height='0.1', depth='0.1', color='yellow')
          a-box(position='2 0 0', width='0.1', height='0.1', depth='0.1', color='yellow')
          a-box(position='-3 0 -5', width='0.1', height='0.1', depth='0.1', color='green')
          a-box(position='-3 0 -4', width='0.1', height='0.1', depth='0.1', color='green')
          a-box(position='-3 0 -3', width='0.1', height='0.1', depth='0.1', color='green')
          a-box(position='-3 0 -2', width='0.1', height='0.1', depth='0.1', color='green')
          a-box(position='-3 0 -1', width='0.1', height='0.1', depth='0.1', color='green')
          a-box(position='-2 0 -5', width='0.1', height='0.1', depth='0.1', color='green')
          a-box(position='-2 0 -4', width='0.1', height='0.1', depth='0.1', color='green')
          a-box(position='-2 0 -3', width='0.1', height='0.1', depth='0.1', color='green')
          a-box(position='-2 0 -2', width='0.1', height='0.1', depth='0.1', color='green')
          a-box(position='-2 0 -1', width='0.1', height='0.1', depth='0.1', color='green')
          a-box(position='-1 0 -5', width='0.1', height='0.1', depth='0.1', color='green')
          a-box(position='-1 0 -4', width='0.1', height='0.1', depth='0.1', color='green')
          a-box(position='-1 0 -3', width='0.1', height='0.1', depth='0.1', color='green')
          a-box(position='-1 0 -2', width='0.1', height='0.1', depth='0.1', color='green')
          a-box(position='-1 0 -1', width='0.1', height='0.1', depth='0.1', color='green')
          a-box(position='0 0 -5', width='0.1', height='0.1', depth='0.1', color='green')
          a-box(position='0 0 -4', width='0.1', height='0.1', depth='0.1', color='green')
          a-box(position='0 0 -3', width='0.1', height='0.1', depth='0.1', color='green')
          a-box(position='0 0 -2', width='0.1', height='0.1', depth='0.1', color='green')
          a-box(position='0 0 -1', width='0.1', height='0.1', depth='0.1', color='green')
          a-box(position='1 0 -5', width='0.1', height='0.1', depth='0.1', color='green')
          a-box(position='1 0 -4', width='0.1', height='0.1', depth='0.1', color='green')
          a-box(position='1 0 -3', width='0.1', height='0.1', depth='0.1', color='green')
          a-box(position='1 0 -2', width='0.1', height='0.1', depth='0.1', color='green')
          ...
          a-plane(static-body, position='0  0 -4', rotation='-90 0 0', width='40', height='50', color='#7BC8A4')
          a-sphere#marker-blue(position='-5 0 -5', radius='0.1', color='blue')
          a-sphere#marker-red(position='5 0 -5', radius='0.1', color='red')
          a-sphere#marker-green(position='0 0 0', radius='0.1', color='green')
      h3 The LowRoller version of the RollerBall
      #bloviation.contents
        p Did you ever see a Samurai movie where the police take down a rampaging samuri?
        p They simply surrounded the samuri with wooden staffs to keep him farther than swords length, and poked him until he gave up. we have nothing like that for a man with a gun. Enter the LowRoller
        p The LowRoller rollerBall is about the size of a basketball or soccerball. It is covered with a hard shell with a surface like leather. It's mass is a few kilograms. It can alter it's center of gravity to roll around. that's it.
        p Even with that limitation, it can gang up at the feet of a person causing a threat. The random motions of the balls will make the attacker lose balance and be unable to continue.
